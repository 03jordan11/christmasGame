...
if (global.conveyersOn[1] && alarm[1] == -1){
	alarm[1] = irandom_range(global.conveyerSpeed[1][0], global.conveyerSpeed[1][0])
}
if (global.conveyersOn[2] && alarm[2] == -1){
	alarm[2] = irandom_range(global.conveyerSpeed[2][0], global.conveyerSpeed[2][0])
}
if (global.conveyersOn[3] && alarm[3] == -1){
	alarm[3] = irandom_range(global.conveyerSpeed[3][0], global.conveyerSpeed[3][0])
}
